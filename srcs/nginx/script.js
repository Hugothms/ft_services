...
function draw() {
  ...
  textSize(30);
  text("hthomas", width / 2, height / 2 + 40);
  textSize(16);
  text("thanks to tmarx for this cute page ;)", width / 2, height - 40);
